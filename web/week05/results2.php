...
<html>
  ...
  <table class="table table-dark table-hover">
   ...
   if ($first_name != "" && $last_name != "" && $phone != "" && $first_name != null && $last_name != null && $phone != null){
    foreach ($db->query("SELECT r.check_in_date as check_in_date, r.check_out_date as check_out_date, r.room_number as room_number FROM reservation r INNER JOIN customer c ON r.customer_id = c.id WHERE c.last_name = '$last_name' AND c.phone = '$phone' AND c.first_name = '$first_name'") as $fRow)
    {   
   ...
   as phone, r.check_in_date as check_in_date, r.check_out_date as check_out_date, r.room_number 
